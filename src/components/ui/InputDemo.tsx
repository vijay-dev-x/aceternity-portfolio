...
export function SignupFormDemo() {
  ...
  return (
    <div className="max-w-md w-full mx-auto rounded-none md:rounded-2xl p-4 md:p-4 shadow-input bg-white dark:bg-black">
      <h2 className="font-bold text-xl text-neutral-800 text-transparent bg-clip-text bg-gradient-to-r from-purple-300 via-purple-700 to-purple-950 md:text-2xl ">
        Welecome to Code Dev x
      </h2>
      <p className=" text-l max-w-sm mt-2  pb-10  text-white/60 ">
