    ...
    <div>
      ...
      <div className=" max-w-7xl md:flex-row flex-col justify-center items-center mx-auto  text-white flex gap-20 ">
        ...
        <div className=" flex flex-col gap-5">
          <button className=" hover:scale-105 transition duration-200 relative inline-flex h-16 overflow-hidden rounded-xl p-[1px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50">
